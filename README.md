...
<body>
 ...
 <main>
        ...
        <section id="home" class="hero">
            <h1>Добро пожаловать в Minecraft!</h1>
            <p>Погрузитесь в мир бесконечных возможностей и творчества.</p>
            <a href="#about" class="btn">Узнать больше</a>
        </section>
        <!-- О игре -->
        <section id="about" class="container">
            <h2>О нашей игре</h2>
            <p>Minecraft - это игра-песочница, разработанная Mojang Studios. Она позволяет игрокам строить из блоков в 3D-мире, требующем творчества.</p>
            <img src="" alt="Скриншот из Minecraft">
            <video width="400" controls>
                <source src="images/minecraft_video.mp4" type="video/mp4">
        ...
        <section id="contact" class="container">
            ...
            <form id="contact-form">
                ...
                <input type="text" id изображений</h2>
            <div class="gallery-container">
                ...
                <div class="gallery-item">
                    <img src="" alt="Изображение 4">
                </div>
                <div class="gallery-item">
                    <img src="" alt="Изображение 5">
                </div>
            </div>
        ...
        <section id="faq" class="container">
            <h2>FAQ</h2>
            <details>
                <summary>Что такое Minecraft?</summary>
                <p>Minecraft - это игра-песочница, разработанная Mojang Studios.</p>
            </details>
            <details>
                <summary>Какие платформы поддерживаются?</summary>
                <p>Minecraft доступен на PC, консолях, и мобильных устройствах.</p>
            </details>
            <details>
                <summary>Как начать играть?</summary>
                <p>Для начала игры необходимо приобрести копию Minecraft на официальном сайте.</p>
            </details>
        </section>
    </main>
    <footer>
